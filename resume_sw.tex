...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Worked as a member of the LM Aero Sensor Fusion team, specializing in Data Association, in an Agile software development team.}
        \resumeItem{Performed Information Fusion with data such as radar, passive sensors, various tactical data links, and more.}
