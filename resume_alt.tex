...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Worked as a member of the Lockheed Martin Aeronautics Sensor Fusion team, specializing in Data Association.}
        ...
        \resumeItem{Reduced significant technical debt of F35 Sensor Fusion code by identifying, resolving and verifying over 50 SPARs (with many being issues that had been present for years)}
        ...
        \resumeItem{Developed signals processing capabilities in Rust and supporting tools and visualizations for capability demos}
      \resumeItemListEnd
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Engineering Tools}{: Mentor Graphics Capital, CATIA , ENOVIA, PDM} \\
     \textbf{Programming Languages}{: C++, Rust, MATLAB, Java, Python, PostgreSQL} \\
